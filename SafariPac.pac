var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)document360\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)gstatic\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)google-analytics\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)yiiguxing\.github\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)better365\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)linkedkeeper\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)boslife\.net$/.test(host)) return "+proxy";
